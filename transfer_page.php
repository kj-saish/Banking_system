...
<body style="background-color : #fcde67 ;">
	...
	<div class="container">
        ...
        <br>
            ...
            <button class="btn mt-3" name="submit" type="submit"  style="background-color : #5bccf6;" id="myBtn" >Transfer</button>
            </div>
        </form>
    </div>
    <br> <br>
   ...
   <!-- Footer section -->
   <footer class="text-center mt-5 py-2" style="background-color : #5bccf6;">
        <p>Built by <b>Saish J. Karkera</b></p>
